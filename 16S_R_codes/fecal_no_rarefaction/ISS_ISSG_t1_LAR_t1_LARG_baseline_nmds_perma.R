...
comp3<-"t.1 - 4 Weeks LAR"
comp3a<-"t.1 - 4 Weeks LAR"
comp3filename<-"t1_LAR"
comp3title<-"Post-Earth Return LAR"

comp4<-"t.1 - 4 Weeks LAR_G"
comp4a<-"t.1 - 4 Weeks LAR_G"
comp4filename<-"t1_LAR_G"
comp4title<-"Post-Earth Return LAR_G"
...
treatment_order=c(comp1a,comp2a,comp3a,comp4a,"baseline")
...
pdf(paste0("NMDS_Bray_",comp1filename,".vs.",comp2filename,".vs.",comp3filename,".vs.",comp4filename,"_",level,".pdf"),width=6,height=6)
color1=colors[[levels(p_pssfpr$data$Compare)[1]]]
color2=colors[[levels(p_pssfpr$data$Compare)[2]]]
color3=colors[[levels(p_pssfpr$data$Compare)[3]]]
color4=colors[[levels(p_pssfpr$data$Compare)[4]]]
color5=colors[["baseline"]]
ppp=p_pssfpr + scale_color_manual(values=c(color1,color2,color3,color4,color5),labels=c(comp1title,comp2title,comp3title,comp4title,"Baseline")) + ggtitle(paste0("NMDS - ",level))
print(ppp)
dev.off()
svg(paste0("NMDS_Bray_",comp1filename,".vs.",comp2filename,".vs.",comp3filename,".vs.",comp4filename,"_",level,".svg"),width=6,height=6)
print(ppp)
dev.off()
...
write_xlsx(pnova$aov.tab,paste0("Permanova_",comp1filename,".vs.",comp2filename,".vs.",comp3filename,".vs.",comp4filename,"_",level,".xlsx"))
##################################
