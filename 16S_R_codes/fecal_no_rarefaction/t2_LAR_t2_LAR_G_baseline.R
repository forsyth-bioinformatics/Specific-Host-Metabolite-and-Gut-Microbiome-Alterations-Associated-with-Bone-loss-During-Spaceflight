...
write.table(richness,file=paste0("Alpha_Diversity_Indices_",comp1filename,".vs.",comp2filename,".vs.","baseline_",level,".txt"),quote = F,sep="\t",col.names=NA)
...
filename=paste0("Alpha_Group_Significance_by_",idx,"_",comp1filename,".vs.",comp2filename,".vs.","baseline_",level,".txt")
