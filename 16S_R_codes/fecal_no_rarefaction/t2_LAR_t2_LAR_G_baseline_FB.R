...
make_fbratio<-function(){
	...
	pdf(paste0("FB_ratios_boxplot_",comp1filename,"_vs_",comp2filename,"_vs_baseline.pdf"),width=5,height=5)
	...
	ppp=ppp+scale_fill_manual(values=c(color1, color2,color3))+scale_color_manual(values=c(color1, color2,color3))
	print(ppp)
	dev.off()
	svg(paste0("FB_ratios_boxplot_",comp1filename,"_vs_",comp2filename,"_vs_baseline.svg"),width=5,height=5)
	print(ppp)
	dev.off()

	filename=paste0("FB_ratios_significance_",comp1filename,"_vs_",comp2filename,"_vs_baseline.txt")
...
make_fbstat<-function(){
	...
	write_xlsx(lll,paste0("Phylum_abundance_",comp1filename,"_vs_",comp2filename,"_vs_baseline.xlsx"))
}
##################################
make_ps()
make_fbratio()
