...
comp2<-"t.2 - 8 Weeks LAR_G"
comp2a<-"t.2 - 8 Weeks LAR_G"
comp2filename<-"t2_LAR_G"
comp2title<-"End-Point LAR_G"
...
ps=physeq
##################################
script=paste0("subset_samples(ps,( Compare == \"Baseline Base\" | ",key1," == comp1 | ",key2," == comp2))")
...
svg(paste0(fld,"/alpha_diversity_box_plots_",comp1filename,".vs.",comp2filename,".vs.","baseline_",level,".svg"), width=8, height=4)
p_rich
dev.off()
pdf(paste0(fld,"/alpha_diversity_box_plots_",comp1filename,".vs.",comp2filename,".vs.","baseline_",level,".pdf"), width=8, height=4)
p_rich
dev.off()
##################################
richness <- estimate_richness(pssfpr,measures=c("Observed","Shannon","Simpson"))
write.table(richness,file=paste0(fld,"/Alpha_Diversity_Indices_",comp1filename,".vs.",comp2filename,".vs.","baseline_",level,".txt"),quote = F,sep="\t",col.names=NA)
...
filename=paste0(fld,"/Alpha_Group_Significance_by_",idx,"_",comp1filename,".vs.",comp2filename,".vs.","baseline_",level,".txt")
...
#capture.output(wilcox,file = filename,append=T)
